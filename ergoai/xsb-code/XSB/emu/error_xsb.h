...
DllExport extern void call_conv xsb_typed_abort(char *,char *, ...);
...
DllExport extern void unifunc_abort(CTXTdeclc int, CPtr);
extern void addintfastuni_abort(CTXTdeclc Cell , Cell);
DllExport extern void arithmetic_abort(CTXTdeclc Cell, char *, Cell);
...
DllExport extern void call_conv xsb_domain_error_vargs(CTXTdeclc char *,Cell,char *, ...);
...
DllExport extern void call_conv xsb_type_error_vargs(CTXTdeclc char *, Cell,char *,char *, ...) ;
DllExport extern void call_conv xsb_library_error_vargs(CTXTdeclc char *, char *, Cell, char *, ...) ;
