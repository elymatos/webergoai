...
:-(FLORA_THIS_WORKSPACE(system_ignore_undefined_errors)(_h1580011,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(system_ignore_undefined_errors))(_h1580011,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(system_turn_off_debug)(_h1580943,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(system_turn_off_debug))(_h1580943,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(system_turn_on_debug)(_h1582579,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(system_turn_on_debug))(_h1582579,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(turn_debug_off_for_call)(_h1584183,_h1584185,_h1584187,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(turn_debug_off_for_call))(_h1584183,_h1584185,_h1584187,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(turn_off_debug_list)(_h1585011,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(turn_off_debug_list))(_h1585011,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(turn_on_debug_list)(_h1585767,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(turn_on_debug_list))(_h1585767,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(system_ignore_undefined_errors)(_h1606182,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(system_ignore_undefined_errors))(_h1606182,FWContext)).
:-(FLORA_THIS_WORKSPACE(system_turn_off_debug)(_h1607109,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(system_turn_off_debug))(_h1607109,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(system_turn_on_debug)(_h1608735,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(system_turn_on_debug))(_h1608735,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(turn_debug_off_for_call)(_h1610329,_h1610331,_h1610333,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(turn_debug_off_for_call))(_h1610329,_h1610331,_h1610333,FWContext)).
:-(FLORA_THIS_WORKSPACE(turn_off_debug_list)(_h1611152,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(turn_off_debug_list))(_h1611152,FWContext)).
:-(FLORA_THIS_WORKSPACE(turn_on_debug_list)(_h1611903,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(turn_on_debug_list))(_h1611903,FWContext)).
