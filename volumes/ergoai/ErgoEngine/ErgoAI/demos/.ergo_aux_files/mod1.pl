...
?-(fllibprogramans(','('_$_$_ergo''silent_equal'(_CallerModuleVar,FLORA_THIS_MODULE_NAME),fllibload([>>(mod2,mod2)],'/home/ematos/devel/ergo/ErgoEngine/ErgoAI/demos/mod1.flr',FLORA_THIS_MODULE_NAME,[8,4])),[])).
