...
?-(fllibprogramans(','('_$_$_ergo''silent_equal'(_CallerModuleVar,FLORA_THIS_MODULE_NAME),','(nl,','(writeln('Loading module2 ...'),fllibload([>>(module2,module2)],'/home/ematos/devel/ergo/ErgoEngine/ErgoAI/demos/module1.flr',FLORA_THIS_MODULE_NAME,[20,49])))),[])).
