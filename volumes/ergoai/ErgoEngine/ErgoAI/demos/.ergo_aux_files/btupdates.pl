...
?-(fllibprogramans(','('_$_$_ergo''silent_equal'(_CallerModuleVar,FLORA_THIS_MODULE_NAME),fllibload([>>(module2,mod2)],'/home/ematos/devel/ergo/ErgoEngine/ErgoAI/demos/btupdates.flr',FLORA_THIS_MODULE_NAME,[4,4])),[])).
