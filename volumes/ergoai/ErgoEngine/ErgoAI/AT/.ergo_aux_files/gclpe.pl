...
#mode save
#mode nocomment "%"
#define FLORA_THIS_FILENAME  'gclpe.ergo'
#mode restore
/************************************************************************
...
:-(FLORA_THIS_WORKSPACE(\\undefeated)(_h794357,_h794359,_h794361,_h794363,_h794365,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(\\undefeated))(_h794357,_h794359,_h794361,_h794363,_h794365,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(beaten_by_strict_rule)(_h795015,_h795017,_h795019,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(beaten_by_strict_rule))(_h795015,_h795017,_h795019,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(beaten_by_strict_rule)(_h795811,_h795813,_h795815,_h795817,_h795819,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(beaten_by_strict_rule))(_h795811,_h795813,_h795815,_h795817,_h795819,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(candidate)(_h796615,_h796617,_h796619,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(candidate))(_h796615,_h796617,_h796619,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(change_module)(_h797219,_h797221,_h797223,_h797225,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(change_module))(_h797219,_h797221,_h797223,_h797225,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(change_module_nocheck)(_h797891,_h797893,_h797895,_h797897,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(change_module_nocheck))(_h797891,_h797893,_h797895,_h797897,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(check_module_to_AT_association)(_h798691,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(check_module_to_AT_association))(_h798691,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(competes)),4),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(competes)),4)),opaque))).
:-(FLORA_THIS_WORKSPACE(competes)(_h799623,_h799625,_h799627,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(competes))(_h799623,_h799625,_h799627,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(competes)),5),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(competes)),5)),opaque))).
:-(FLORA_THIS_WORKSPACE(competes)(_h800211,_h800213,_h800215,_h800217,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(competes))(_h800211,_h800213,_h800215,_h800217,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(defeated)),4),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(defeated)),4)),opaque))).
:-(FLORA_THIS_WORKSPACE(defeated)(_h800803,_h800805,_h800807,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(defeated))(_h800803,_h800805,_h800807,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(defeated_id)(_h801391,_h801393,_h801395,_h801397,_h801399,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(defeated_id))(_h801391,_h801393,_h801395,_h801397,_h801399,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(disqualified)(_h802035,_h802037,_h802039,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(disqualified))(_h802035,_h802037,_h802039,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(rebuts)),4),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(rebuts)),4)),opaque))).
:-(FLORA_THIS_WORKSPACE(rebuts)(_h802687,_h802689,_h802691,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(rebuts))(_h802687,_h802689,_h802691,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(rebuts)),5),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(rebuts)),5)),opaque))).
:-(FLORA_THIS_WORKSPACE(rebuts)(_h803243,_h803245,_h803247,_h803249,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(rebuts))(_h803243,_h803245,_h803247,_h803249,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(refutes)),5),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(refutes)),5)),opaque))).
:-(FLORA_THIS_WORKSPACE(refutes)(_h803803,_h803805,_h803807,_h803809,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(refutes))(_h803803,_h803805,_h803807,_h803809,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(refutes)),6),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(refutes)),6)),opaque))).
:-(FLORA_THIS_WORKSPACE(refutes)(_h804379,_h804381,_h804383,_h804385,_h804387,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(refutes))(_h804379,_h804381,_h804383,_h804385,_h804387,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(strict_candidate)(_h804959,_h804961,_h804963,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(strict_candidate))(_h804959,_h804961,_h804963,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(tightBinaryExclusion)(_h805675,_h805677,_h805679,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(tightBinaryExclusion))(_h805675,_h805677,_h805679,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(tightExclusion)(_h806455,_h806457,_h806459,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(tightExclusion))(_h806455,_h806457,_h806459,FWContext)).
...
#mode save
#mode nocomment "%"
#define FLORA_FLM_FILENAME  'gclpe.flm'
#mode restore
...
#endif
?-(:(flrutils,flora_read_descriptor_metafacts_canonical_and_insert(gclpe,_ErrNum))).
#endif
...
#mode save
#mode nocomment "%"
#define FLORA_FLD_FILENAME  'gclpe.fld'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS_FILENAME  'gclpe.fls'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS2_FILENAME  'gclpe.fls2'
#mode restore
...
?-(:(flrutils,util_load_structdb('gclpe.ergo',FLORA_THIS_MODULE_NAME))).
...
:-(FLORA_THIS_WORKSPACE(\\undefeated)(_h834835,_h834837,_h834839,_h834841,_h834843,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(\\undefeated))(_h834835,_h834837,_h834839,_h834841,_h834843,FWContext)).
:-(FLORA_THIS_WORKSPACE(beaten_by_strict_rule)(_h835488,_h835490,_h835492,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(beaten_by_strict_rule))(_h835488,_h835490,_h835492,FWContext)).
:-(FLORA_THIS_WORKSPACE(beaten_by_strict_rule)(_h836279,_h836281,_h836283,_h836285,_h836287,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(beaten_by_strict_rule))(_h836279,_h836281,_h836283,_h836285,_h836287,FWContext)).
:-(FLORA_THIS_WORKSPACE(candidate)(_h837078,_h837080,_h837082,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(candidate))(_h837078,_h837080,_h837082,FWContext)).
:-(FLORA_THIS_WORKSPACE(change_module)(_h837677,_h837679,_h837681,_h837683,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(change_module))(_h837677,_h837679,_h837681,_h837683,FWContext)).
:-(FLORA_THIS_WORKSPACE(change_module_nocheck)(_h838344,_h838346,_h838348,_h838350,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(change_module_nocheck))(_h838344,_h838346,_h838348,_h838350,FWContext)).
:-(FLORA_THIS_WORKSPACE(check_module_to_AT_association)(_h839139,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(check_module_to_AT_association))(_h839139,FWContext)).
:-(FLORA_THIS_WORKSPACE(competes)(_h840066,_h840068,_h840070,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(competes))(_h840066,_h840068,_h840070,FWContext)).
:-(FLORA_THIS_WORKSPACE(competes)(_h840649,_h840651,_h840653,_h840655,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(competes))(_h840649,_h840651,_h840653,_h840655,FWContext)).
:-(FLORA_THIS_WORKSPACE(defeated)(_h841236,_h841238,_h841240,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(defeated))(_h841236,_h841238,_h841240,FWContext)).
:-(FLORA_THIS_WORKSPACE(defeated_id)(_h841819,_h841821,_h841823,_h841825,_h841827,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(defeated_id))(_h841819,_h841821,_h841823,_h841825,_h841827,FWContext)).
:-(FLORA_THIS_WORKSPACE(disqualified)(_h842458,_h842460,_h842462,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(disqualified))(_h842458,_h842460,_h842462,FWContext)).
:-(FLORA_THIS_WORKSPACE(rebuts)(_h843105,_h843107,_h843109,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(rebuts))(_h843105,_h843107,_h843109,FWContext)).
:-(FLORA_THIS_WORKSPACE(rebuts)(_h843656,_h843658,_h843660,_h843662,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(rebuts))(_h843656,_h843658,_h843660,_h843662,FWContext)).
:-(FLORA_THIS_WORKSPACE(refutes)(_h844211,_h844213,_h844215,_h844217,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(refutes))(_h844211,_h844213,_h844215,_h844217,FWContext)).
:-(FLORA_THIS_WORKSPACE(refutes)(_h844782,_h844784,_h844786,_h844788,_h844790,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(refutes))(_h844782,_h844784,_h844786,_h844788,_h844790,FWContext)).
:-(FLORA_THIS_WORKSPACE(strict_candidate)(_h845357,_h845359,_h845361,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(strict_candidate))(_h845357,_h845359,_h845361,FWContext)).
:-(FLORA_THIS_WORKSPACE(tightBinaryExclusion)(_h846068,_h846070,_h846072,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(tightBinaryExclusion))(_h846068,_h846070,_h846072,FWContext)).
:-(FLORA_THIS_WORKSPACE(tightExclusion)(_h846843,_h846845,_h846847,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(tightExclusion))(_h846843,_h846845,_h846847,FWContext)).
