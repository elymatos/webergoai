...
#mode save
#mode nocomment "%"
#define FLORA_THIS_FILENAME  'ogclp.ergo'
#mode restore
/************************************************************************
...
:-(FLORA_THIS_WORKSPACE(\\undefeated)(_h654512,_h654514,_h654516,_h654518,_h654520,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(\\undefeated))(_h654512,_h654514,_h654516,_h654518,_h654520,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(beaten_by_strict_rule)(_h655170,_h655172,_h655174,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(beaten_by_strict_rule))(_h655170,_h655172,_h655174,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(beaten_by_strict_rule)(_h655966,_h655968,_h655970,_h655972,_h655974,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(beaten_by_strict_rule))(_h655966,_h655968,_h655970,_h655972,_h655974,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(candidate)(_h656770,_h656772,_h656774,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(candidate))(_h656770,_h656772,_h656774,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(change_module)(_h657374,_h657376,_h657378,_h657380,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(change_module))(_h657374,_h657376,_h657378,_h657380,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(change_module_nocheck)(_h658046,_h658048,_h658050,_h658052,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(change_module_nocheck))(_h658046,_h658048,_h658050,_h658052,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(check_module_to_AT_association)(_h658846,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(check_module_to_AT_association))(_h658846,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(compromized)(_h659778,_h659780,_h659782,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(compromized))(_h659778,_h659780,_h659782,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(conflicts)(_h660414,_h660416,_h660418,_h660420,_h660422,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(conflicts))(_h660414,_h660416,_h660418,_h660420,_h660422,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(defeated)(_h661026,_h661028,_h661030,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(defeated))(_h661026,_h661028,_h661030,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(defeated_id)(_h661614,_h661616,_h661618,_h661620,_h661622,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(defeated_id))(_h661614,_h661616,_h661618,_h661620,_h661622,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(defeats)),6),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(defeats)),6)),opaque))).
:-(FLORA_THIS_WORKSPACE(defeats)(_h662258,_h662260,_h662262,_h662264,_h662266,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(defeats))(_h662258,_h662260,_h662262,_h662264,_h662266,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(disqualified)(_h662838,_h662840,_h662842,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(disqualified))(_h662838,_h662840,_h662842,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(rebuts)),6),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(rebuts)),6)),opaque))).
:-(FLORA_THIS_WORKSPACE(rebuts)(_h663490,_h663492,_h663494,_h663496,_h663498,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(rebuts))(_h663490,_h663492,_h663494,_h663496,_h663498,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(rebutted)),4),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(rebutted)),4)),opaque))).
:-(FLORA_THIS_WORKSPACE(rebutted)(_h664054,_h664056,_h664058,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(rebutted))(_h664054,_h664056,_h664058,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(refuted)),4),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(refuted)),4)),opaque))).
:-(FLORA_THIS_WORKSPACE(refuted)(_h664642,_h664644,_h664646,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(refuted))(_h664642,_h664644,_h664646,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(refutes)),6),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(refutes)),6)),opaque))).
:-(FLORA_THIS_WORKSPACE(refutes)(_h665214,_h665216,_h665218,_h665220,_h665222,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(refutes))(_h665214,_h665216,_h665218,_h665220,_h665222,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(strict_candidate)(_h665794,_h665796,_h665798,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(strict_candidate))(_h665794,_h665796,_h665798,FWContext)).
...
#mode save
#mode nocomment "%"
#define FLORA_FLM_FILENAME  'ogclp.flm'
#mode restore
...
#endif
?-(:(flrutils,flora_read_descriptor_metafacts_canonical_and_insert(ogclp,_ErrNum))).
#endif
...
#mode save
#mode nocomment "%"
#define FLORA_FLD_FILENAME  'ogclp.fld'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS_FILENAME  'ogclp.fls'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS2_FILENAME  'ogclp.fls2'
#mode restore
...
?-(:(flrutils,util_load_structdb('ogclp.ergo',FLORA_THIS_MODULE_NAME))).
...
:-(FLORA_THIS_WORKSPACE(\\undefeated)(_h689155,_h689157,_h689159,_h689161,_h689163,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(\\undefeated))(_h689155,_h689157,_h689159,_h689161,_h689163,FWContext)).
:-(FLORA_THIS_WORKSPACE(beaten_by_strict_rule)(_h689808,_h689810,_h689812,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(beaten_by_strict_rule))(_h689808,_h689810,_h689812,FWContext)).
:-(FLORA_THIS_WORKSPACE(beaten_by_strict_rule)(_h690599,_h690601,_h690603,_h690605,_h690607,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(beaten_by_strict_rule))(_h690599,_h690601,_h690603,_h690605,_h690607,FWContext)).
:-(FLORA_THIS_WORKSPACE(candidate)(_h691398,_h691400,_h691402,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(candidate))(_h691398,_h691400,_h691402,FWContext)).
:-(FLORA_THIS_WORKSPACE(change_module)(_h691997,_h691999,_h692001,_h692003,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(change_module))(_h691997,_h691999,_h692001,_h692003,FWContext)).
:-(FLORA_THIS_WORKSPACE(change_module_nocheck)(_h692664,_h692666,_h692668,_h692670,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(change_module_nocheck))(_h692664,_h692666,_h692668,_h692670,FWContext)).
:-(FLORA_THIS_WORKSPACE(check_module_to_AT_association)(_h693459,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(check_module_to_AT_association))(_h693459,FWContext)).
:-(FLORA_THIS_WORKSPACE(compromized)(_h694386,_h694388,_h694390,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(compromized))(_h694386,_h694388,_h694390,FWContext)).
:-(FLORA_THIS_WORKSPACE(conflicts)(_h695017,_h695019,_h695021,_h695023,_h695025,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(conflicts))(_h695017,_h695019,_h695021,_h695023,_h695025,FWContext)).
:-(FLORA_THIS_WORKSPACE(defeated)(_h695624,_h695626,_h695628,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(defeated))(_h695624,_h695626,_h695628,FWContext)).
:-(FLORA_THIS_WORKSPACE(defeated_id)(_h696207,_h696209,_h696211,_h696213,_h696215,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(defeated_id))(_h696207,_h696209,_h696211,_h696213,_h696215,FWContext)).
:-(FLORA_THIS_WORKSPACE(defeats)(_h696846,_h696848,_h696850,_h696852,_h696854,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(defeats))(_h696846,_h696848,_h696850,_h696852,_h696854,FWContext)).
:-(FLORA_THIS_WORKSPACE(disqualified)(_h697421,_h697423,_h697425,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(disqualified))(_h697421,_h697423,_h697425,FWContext)).
:-(FLORA_THIS_WORKSPACE(rebuts)(_h698068,_h698070,_h698072,_h698074,_h698076,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(rebuts))(_h698068,_h698070,_h698072,_h698074,_h698076,FWContext)).
:-(FLORA_THIS_WORKSPACE(rebutted)(_h698627,_h698629,_h698631,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(rebutted))(_h698627,_h698629,_h698631,FWContext)).
:-(FLORA_THIS_WORKSPACE(refuted)(_h699210,_h699212,_h699214,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(refuted))(_h699210,_h699212,_h699214,FWContext)).
:-(FLORA_THIS_WORKSPACE(refutes)(_h699777,_h699779,_h699781,_h699783,_h699785,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(refutes))(_h699777,_h699779,_h699781,_h699783,_h699785,FWContext)).
:-(FLORA_THIS_WORKSPACE(strict_candidate)(_h700352,_h700354,_h700356,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(strict_candidate))(_h700352,_h700354,_h700356,FWContext)).
