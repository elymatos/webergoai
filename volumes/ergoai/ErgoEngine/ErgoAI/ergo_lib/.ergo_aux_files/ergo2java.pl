...
:-(FLORA_THIS_WORKSPACE(check_window)(_h549081,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(check_window))(_h549081,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(is_atomlist)(_h549725,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(is_atomlist))(_h549725,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(readline_chop_nl)(_h550353,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(readline_chop_nl))(_h550353,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(show_options_dialog)(_h551061,_h551063,_h551065,_h551067,_h551069,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(show_options_dialog))(_h551061,_h551063,_h551065,_h551067,_h551069,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(check_window)(_h571995,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(check_window))(_h571995,FWContext)).
:-(FLORA_THIS_WORKSPACE(is_atomlist)(_h572634,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(is_atomlist))(_h572634,FWContext)).
:-(FLORA_THIS_WORKSPACE(readline_chop_nl)(_h573257,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(readline_chop_nl))(_h573257,FWContext)).
:-(FLORA_THIS_WORKSPACE(show_options_dialog)(_h573960,_h573962,_h573964,_h573966,_h573968,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(show_options_dialog))(_h573960,_h573962,_h573964,_h573966,_h573968,FWContext)).
