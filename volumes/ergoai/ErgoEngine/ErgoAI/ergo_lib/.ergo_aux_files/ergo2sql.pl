...
?-(fllibprogramans(','('_$_$_ergo''silent_equal'(_CallerModuleVar,FLORA_THIS_MODULE_NAME),','(:(flrutils,flora_feedback_control(tempoff)),fllibload([dbdrivers],'/home/ematos/devel/ergo/ErgoEngine/ErgoAI/ergo_lib/ergo2sql.ergo',FLORA_THIS_MODULE_NAME,[46,2]))),[])).
