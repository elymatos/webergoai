...
:-(FLORA_THIS_WORKSPACE(all_support)(_h1354173,_h1354175,_h1354177,_h1354179,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(all_support))(_h1354173,_h1354175,_h1354177,_h1354179,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(change_module_if_match)(_h1354813,_h1354815,_h1354817,_h1354819,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(change_module_if_match))(_h1354813,_h1354815,_h1354817,_h1354819,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(check_callable)(_h1355629,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(check_callable))(_h1355629,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(check_justification_type)(_h1356305,_h1356307,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(check_justification_type))(_h1356305,_h1356307,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(childOfDefeated)(_h1357145,_h1357147,_h1357149,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(childOfDefeated))(_h1357145,_h1357147,_h1357149,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(choose_rule_text)(_h1357845,_h1357847,_h1357849,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(choose_rule_text))(_h1357845,_h1357847,_h1357849,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(convert_to_text)(_h1358561,_h1358563,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(convert_to_text))(_h1358561,_h1358563,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(explanation2json)(_h1359257,_h1359259,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(explanation2json))(_h1359257,_h1359259,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(explanationSupport2json)(_h1359969,_h1359971,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(explanationSupport2json))(_h1359969,_h1359971,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(full_support_info)(_h1360793,_h1360795,_h1360797,_h1360799,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(full_support_info))(_h1360793,_h1360795,_h1360797,_h1360799,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(get_justification_type)(_h1361529,_h1361531,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(get_justification_type))(_h1361529,_h1361531,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(get_rule_text)(_h1362337,_h1362339,_h1362341,_h1362343,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(get_rule_text))(_h1362337,_h1362339,_h1362341,_h1362343,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(goal_NOT_to_ignore)(_h1363009,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(goal_NOT_to_ignore))(_h1363009,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(ignored_goal)(_h1363749,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(ignored_goal))(_h1363749,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(immediate_support)(_h1364393,_h1364395,_h1364397,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(immediate_support))(_h1364393,_h1364395,_h1364397,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(immediate_support_internal)(_h1365125,_h1365127,_h1365129,_h1365131,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(immediate_support_internal))(_h1365125,_h1365127,_h1365129,_h1365131,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(justificationTreeFunction)(_h1366005,_h1366007,_h1366009,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(justificationTreeFunction))(_h1366005,_h1366007,_h1366009,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(paraphrase)),3),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(paraphrase)),3)),opaque))).
:-(FLORA_THIS_WORKSPACE(paraphrase)(_h1366865,_h1366867,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(paraphrase))(_h1366865,_h1366867,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(printable_axiom)(_h1367481,_h1367483,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(printable_axiom))(_h1367481,_h1367483,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(size_of_explanation)(_h1368177,_h1368179,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(size_of_explanation))(_h1368177,_h1368179,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(support_info)(_h1368937,_h1368939,_h1368941,_h1368943,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(support_info))(_h1368937,_h1368939,_h1368941,_h1368943,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(support_object_is_not_aggregate_body)(_h1369593,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(support_object_is_not_aggregate_body))(_h1369593,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(static^mvd)(__SupportObj,goal,__Goal,'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(38,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),','(','(:(flrdatatype,flora_is_nonvar_prim(__SupportObj)),','(=(__SupportObj,flapply(__type,__PreGoal,__newdontcarevar3,__newdontcarevar4,__newdontcarevar5,__newdontcarevar6,__newdontcarevar7)),','(';'(->(=(__PreGoal,flapply(rebuttedBy,__newdontcarevar8,__Goal)),'\\true'),';'(->(=(__PreGoal,flapply(refutedBy,__newdontcarevar9,__Goal)),'\\true'),';'(->(=(__PreGoal,flapply(disqualified,__newdontcarevar10,__newdontcarevar11,','(__newdontcarevar12,__Goal))),'\\true'),';'(->(=(__PreGoal,flapply(beatenByStrictRule,__newdontcarevar13,__newdontcarevar14,','(__newdontcarevar15,__Goal))),'\\true'),';'(->(=(__PreGoal,flapply(overridenCancellation,__newdontcarevar16,__newdontcarevar17,','(__newdontcarevar18,__Goal))),'\\true'),=(__Goal,__PreGoal)))))),','(:(flrsetops,flora_list_member(__type,[w,m,d])),!)))),fllibexecute_delayed_calls([__Goal,__PreGoal,__SupportObj,__newdontcarevar19,__type],[__Goal,__SupportObj])))).
...
:-(FLORA_THIS_WORKSPACE(printable_axiom)(overridenCancellation,'canceling rule defeated because it has lower priority than the rule being canceled','_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(114,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),!)).
:-(FLORA_THIS_WORKSPACE(printable_axiom)('aggregate expression','computed via an aggregate function','_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(116,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),!)).
:-(FLORA_THIS_WORKSPACE(printable_axiom)(canceled,'defeated by cancellation','_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(118,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),!)).
FLORA_THIS_WORKSPACE(printable_axiom)(___X,___X,'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)).
:-(FLORA_THIS_WORKSPACE(support_object_is_not_aggregate_body)(__SuppObj,'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(120,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),','(','(:(flrdatatype,flora_is_nonvar_prim(__SuppObj)),','(=(__SuppObj,flapply(___Type,__newdontcarevar3,__newdontcarevar4,__newdontcarevar5,__CallerId,__newdontcarevar6,__newdontcarevar7)),\==(__CallerId,fj_bodyExpression))),fllibexecute_delayed_calls([__CallerId,__SuppObj,__newdontcarevar8,___Type],[__SuppObj])))).
...
:-(FLORA_THIS_WORKSPACE(explanationSupport2json)([],[],'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(128,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),!)).
:-(FLORA_THIS_WORKSPACE(explanationSupport2json)([__Expl|__SupportList],[__ExplJson,__Separator|__SupportJson],'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(130,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),','(FLORA_THIS_WORKSPACE(explanation2json)(__Expl,__ExplJson,'_$ctxt'(FLORA_THIS_MODULE_NAME,__newcontextvar3,__newcontextvar4)),','(';'(->(==(__SupportList,[]),=(__Separator,'')),=(__Separator,',')),FLORA_THIS_WORKSPACE(explanationSupport2json)(__SupportList,__SupportJson,'_$ctxt'(FLORA_THIS_MODULE_NAME,__newcontextvar5,__newcontextvar6)))))).
:-(FLORA_THIS_WORKSPACE(static^tblflapply)(using_sorted_explanations,'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(132,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),:(gensym,conget('_$_$ergo^use unsorted explanations',0)))).
:-(FLORA_THIS_WORKSPACE(static^tblflapply)(using_unsorted_explanations,'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(134,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),:(gensym,conget('_$_$ergo^use unsorted explanations',1)))).
:-(FLORA_THIS_WORKSPACE(static^tblflapply)(use_sorted_explanations,'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(136,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),:(gensym,conset('_$_$ergo^use unsorted explanations',0)))).
:-(FLORA_THIS_WORKSPACE(static^tblflapply)(use_unsorted_explanations,'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(138,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),:(gensym,conset('_$_$ergo^use unsorted explanations',1)))).
:-(FLORA_THIS_WORKSPACE(static^nontblflapply)(set_max_explanation_depth,__Depth,'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(140,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),','(FLORA_THIS_WORKSPACE(d^nontblflapply)(clear_max_explanation_depth,'_$ctxt'(FLORA_THIS_MODULE_NAME,__newcontextvar3,__newcontextvar4)),fllibinsert(FLORA_THIS_MODULE_NAME,[flsysdbupdate(FLORA_THIS_WORKSPACE(tblflapply)(max_explanation_depth,__Depth,'_$ctxt'(_DynRuleCallerModuleVar,__newcontextvar5,__newcontextvar6)),FLORA_THIS_FDB_STORAGE,FLORA_THIS_MODULE_NAME)])))).
:-(FLORA_THIS_WORKSPACE(static^nontblflapply)(clear_max_explanation_depth,'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(142,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),','(fllibdeleteall(FLORA_THIS_MODULE_NAME,[flsysdbupdate(FLORA_THIS_WORKSPACE(tblflapply)(max_explanation_depth,__newdontcarevar3,'_$ctxt'(FLORA_THIS_MODULE_NAME,__newcontextvar4,__newcontextvar5)),FLORA_THIS_FDB_STORAGE,FLORA_THIS_MODULE_NAME)]),fllibexecute_delayed_calls([__newdontcarevar6],[])))).
:-(FLORA_THIS_WORKSPACE(static^nontblflapply)(get_max_explanation_depth,__Depth,'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(144,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),FLORA_THIS_WORKSPACE(d^tblflapply)(max_explanation_depth,__Depth,'_$ctxt'(FLORA_THIS_MODULE_NAME,__newcontextvar3,__newcontextvar4)))).
:-(FLORA_THIS_WORKSPACE(static^nontblflapply)(ignore_repeated_subgoals,'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(146,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),:(ergo_explain_utils,ergo_ignore_repeated_subgoals(on)))).
:-(FLORA_THIS_WORKSPACE(static^nontblflapply)(expand_repeated_subgoals,'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(148,'ergo_explain.ergo',FLORA_THIS_MODULE_NAME),:(ergo_explain_utils,ergo_ignore_repeated_subgoals(off)))).
...
:-(FLORA_THIS_WORKSPACE(all_support)(_h1411858,_h1411860,_h1411862,_h1411864,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(all_support))(_h1411858,_h1411860,_h1411862,_h1411864,FWContext)).
:-(FLORA_THIS_WORKSPACE(change_module_if_match)(_h1412493,_h1412495,_h1412497,_h1412499,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(change_module_if_match))(_h1412493,_h1412495,_h1412497,_h1412499,FWContext)).
:-(FLORA_THIS_WORKSPACE(check_callable)(_h1413304,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(check_callable))(_h1413304,FWContext)).
:-(FLORA_THIS_WORKSPACE(check_justification_type)(_h1413975,_h1413977,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(check_justification_type))(_h1413975,_h1413977,FWContext)).
:-(FLORA_THIS_WORKSPACE(childOfDefeated)(_h1414810,_h1414812,_h1414814,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(childOfDefeated))(_h1414810,_h1414812,_h1414814,FWContext)).
:-(FLORA_THIS_WORKSPACE(choose_rule_text)(_h1415505,_h1415507,_h1415509,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(choose_rule_text))(_h1415505,_h1415507,_h1415509,FWContext)).
:-(FLORA_THIS_WORKSPACE(convert_to_text)(_h1416216,_h1416218,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(convert_to_text))(_h1416216,_h1416218,FWContext)).
:-(FLORA_THIS_WORKSPACE(explanation2json)(_h1416907,_h1416909,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(explanation2json))(_h1416907,_h1416909,FWContext)).
:-(FLORA_THIS_WORKSPACE(explanationSupport2json)(_h1417614,_h1417616,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(explanationSupport2json))(_h1417614,_h1417616,FWContext)).
:-(FLORA_THIS_WORKSPACE(full_support_info)(_h1418433,_h1418435,_h1418437,_h1418439,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(full_support_info))(_h1418433,_h1418435,_h1418437,_h1418439,FWContext)).
:-(FLORA_THIS_WORKSPACE(get_justification_type)(_h1419164,_h1419166,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(get_justification_type))(_h1419164,_h1419166,FWContext)).
:-(FLORA_THIS_WORKSPACE(get_rule_text)(_h1419967,_h1419969,_h1419971,_h1419973,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(get_rule_text))(_h1419967,_h1419969,_h1419971,_h1419973,FWContext)).
:-(FLORA_THIS_WORKSPACE(goal_NOT_to_ignore)(_h1420634,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(goal_NOT_to_ignore))(_h1420634,FWContext)).
:-(FLORA_THIS_WORKSPACE(ignored_goal)(_h1421369,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(ignored_goal))(_h1421369,FWContext)).
:-(FLORA_THIS_WORKSPACE(immediate_support)(_h1422008,_h1422010,_h1422012,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(immediate_support))(_h1422008,_h1422010,_h1422012,FWContext)).
:-(FLORA_THIS_WORKSPACE(immediate_support_internal)(_h1422735,_h1422737,_h1422739,_h1422741,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(immediate_support_internal))(_h1422735,_h1422737,_h1422739,_h1422741,FWContext)).
:-(FLORA_THIS_WORKSPACE(justificationTreeFunction)(_h1423610,_h1423612,_h1423614,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(justificationTreeFunction))(_h1423610,_h1423612,_h1423614,FWContext)).
:-(FLORA_THIS_WORKSPACE(paraphrase)(_h1424465,_h1424467,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(paraphrase))(_h1424465,_h1424467,FWContext)).
:-(FLORA_THIS_WORKSPACE(printable_axiom)(_h1425076,_h1425078,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(printable_axiom))(_h1425076,_h1425078,FWContext)).
:-(FLORA_THIS_WORKSPACE(size_of_explanation)(_h1425767,_h1425769,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(size_of_explanation))(_h1425767,_h1425769,FWContext)).
:-(FLORA_THIS_WORKSPACE(support_info)(_h1426522,_h1426524,_h1426526,_h1426528,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(support_info))(_h1426522,_h1426524,_h1426526,_h1426528,FWContext)).
:-(FLORA_THIS_WORKSPACE(support_object_is_not_aggregate_body)(_h1427173,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(support_object_is_not_aggregate_body))(_h1427173,FWContext)).
