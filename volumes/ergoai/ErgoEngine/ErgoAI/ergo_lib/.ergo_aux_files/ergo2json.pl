...
:-(FLORA_THIS_WORKSPACE(get_json_root_fact)(_h821038,_h821040,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(get_json_root_fact))(_h821038,_h821040,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(json_facts)),5),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(json_facts)),5)),opaque))).
:-(FLORA_THIS_WORKSPACE(json_facts)(_h821782,_h821784,_h821786,_h821788,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(json_facts))(_h821782,_h821784,_h821786,_h821788,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(json_facts)),6),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(json_facts)),6)),opaque))).
:-(FLORA_THIS_WORKSPACE(json_facts)(_h822406,_h822408,_h822410,_h822412,_h822414,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(json_facts))(_h822406,_h822408,_h822410,_h822412,_h822414,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(json_facts_to_file)(_h823034,_h823036,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(json_facts_to_file))(_h823034,_h823036,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(json_facts_to_file_aux)(_h823778,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(json_facts_to_file_aux))(_h823778,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(json_facts_to_memory)(_h824582,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(json_facts_to_memory))(_h824582,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(json_keyval_facts)(_h825354,_h825356,_h825358,_h825360,_h825362,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(json_keyval_facts))(_h825354,_h825356,_h825358,_h825360,_h825362,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(new_json_root)(_h826094,_h826096,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(new_json_root))(_h826094,_h826096,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(object_has_been_seen)(_h826758,_h826760,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(object_has_been_seen))(_h826758,_h826760,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(object_to_json_aux)(_h827534,_h827536,_h827538,_h827540,_h827542,_h827544,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(object_to_json_aux))(_h827534,_h827536,_h827538,_h827540,_h827542,_h827544,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(process_key_val_pairs)(_h828294,_h828296,_h828298,_h828300,_h828302,_h828304,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(process_key_val_pairs))(_h828294,_h828296,_h828298,_h828300,_h828302,_h828304,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(save_json_root)(_h829102,_h829104,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(save_json_root))(_h829102,_h829104,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(term_to_json_aux)(_h829782,_h829784,_h829786,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(term_to_json_aux))(_h829782,_h829784,_h829786,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(term_to_json_list)(_h830498,_h830500,_h830502,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(term_to_json_list))(_h830498,_h830500,_h830502,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(term_to_json_list_aux)(_h831230,_h831232,_h831234,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(term_to_json_list_aux))(_h831230,_h831232,_h831234,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(get_json_root_fact)(_h858343,_h858345,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(get_json_root_fact))(_h858343,_h858345,FWContext)).
:-(FLORA_THIS_WORKSPACE(json_facts)(_h859082,_h859084,_h859086,_h859088,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(json_facts))(_h859082,_h859084,_h859086,_h859088,FWContext)).
:-(FLORA_THIS_WORKSPACE(json_facts)(_h859701,_h859703,_h859705,_h859707,_h859709,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(json_facts))(_h859701,_h859703,_h859705,_h859707,_h859709,FWContext)).
:-(FLORA_THIS_WORKSPACE(json_facts_to_file)(_h860324,_h860326,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(json_facts_to_file))(_h860324,_h860326,FWContext)).
:-(FLORA_THIS_WORKSPACE(json_facts_to_file_aux)(_h861063,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(json_facts_to_file_aux))(_h861063,FWContext)).
:-(FLORA_THIS_WORKSPACE(json_facts_to_memory)(_h861862,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(json_facts_to_memory))(_h861862,FWContext)).
:-(FLORA_THIS_WORKSPACE(json_keyval_facts)(_h862629,_h862631,_h862633,_h862635,_h862637,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(json_keyval_facts))(_h862629,_h862631,_h862633,_h862635,_h862637,FWContext)).
:-(FLORA_THIS_WORKSPACE(new_json_root)(_h863364,_h863366,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(new_json_root))(_h863364,_h863366,FWContext)).
:-(FLORA_THIS_WORKSPACE(object_has_been_seen)(_h864023,_h864025,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(object_has_been_seen))(_h864023,_h864025,FWContext)).
:-(FLORA_THIS_WORKSPACE(object_to_json_aux)(_h864794,_h864796,_h864798,_h864800,_h864802,_h864804,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(object_to_json_aux))(_h864794,_h864796,_h864798,_h864800,_h864802,_h864804,FWContext)).
:-(FLORA_THIS_WORKSPACE(process_key_val_pairs)(_h865549,_h865551,_h865553,_h865555,_h865557,_h865559,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(process_key_val_pairs))(_h865549,_h865551,_h865553,_h865555,_h865557,_h865559,FWContext)).
:-(FLORA_THIS_WORKSPACE(save_json_root)(_h866352,_h866354,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(save_json_root))(_h866352,_h866354,FWContext)).
:-(FLORA_THIS_WORKSPACE(term_to_json_aux)(_h867027,_h867029,_h867031,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(term_to_json_aux))(_h867027,_h867029,_h867031,FWContext)).
:-(FLORA_THIS_WORKSPACE(term_to_json_list)(_h867738,_h867740,_h867742,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(term_to_json_list))(_h867738,_h867740,_h867742,FWContext)).
:-(FLORA_THIS_WORKSPACE(term_to_json_list_aux)(_h868465,_h868467,_h868469,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(term_to_json_list_aux))(_h868465,_h868467,_h868469,FWContext)).
