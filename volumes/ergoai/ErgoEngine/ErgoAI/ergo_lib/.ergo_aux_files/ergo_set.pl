...
:-(FLORA_THIS_WORKSPACE(check_set_name)(_h650266,_h650268,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(check_set_name))(_h650266,_h650268,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(copy_into)),4),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(copy_into)),4)),opaque))).
:-(FLORA_THIS_WORKSPACE(copy_into)(_h650946,_h650948,_h650950,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(copy_into))(_h650946,_h650948,_h650950,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(copy_into_intersect)(_h651550,_h651552,_h651554,_h651556,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(copy_into_intersect))(_h651550,_h651552,_h651554,_h651556,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(copy_into_minus)(_h652318,_h652320,_h652322,_h652324,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(copy_into_minus))(_h652318,_h652320,_h652322,_h652324,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(delete_all_pairs)(_h653022,_h653024,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(delete_all_pairs))(_h653022,_h653024,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(delete_facts)(_h653734,_h653736,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(delete_facts))(_h653734,_h653736,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(delete_from)(_h654382,_h654384,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(delete_from))(_h654382,_h654384,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(genericdelete)(_h655014,_h655016,_h655018,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(genericdelete))(_h655014,_h655016,_h655018,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(genericinsert)(_h655682,_h655684,_h655686,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(genericinsert))(_h655682,_h655684,_h655686,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(genericintersect)(_h656350,_h656352,_h656354,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(genericintersect))(_h656350,_h656352,_h656354,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(genericmember)(_h657066,_h657068,_h657070,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(genericmember))(_h657066,_h657068,_h657070,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(genericminus)(_h657734,_h657736,_h657738,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(genericminus))(_h657734,_h657736,_h657738,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(genericsubset)(_h658386,_h658388,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(genericsubset))(_h658386,_h658388,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(genericunion)(_h659050,_h659052,_h659054,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(genericunion))(_h659050,_h659052,_h659054,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(get_storage_name)(_h659702,_h659704,_h659706,_h659708,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(get_storage_name))(_h659702,_h659704,_h659706,_h659708,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(insert_facts)(_h660422,_h660424,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(insert_facts))(_h660422,_h660424,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(registry_of_sets)(_h661070,_h661072,_h661074,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(registry_of_sets))(_h661070,_h661072,_h661074,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(struct_printable_type)(_h661786,_h661788,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(struct_printable_type))(_h661786,_h661788,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(check_set_name)(_h688386,_h688388,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(check_set_name))(_h688386,_h688388,FWContext)).
:-(FLORA_THIS_WORKSPACE(copy_into)(_h689061,_h689063,_h689065,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(copy_into))(_h689061,_h689063,_h689065,FWContext)).
:-(FLORA_THIS_WORKSPACE(copy_into_intersect)(_h689660,_h689662,_h689664,_h689666,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(copy_into_intersect))(_h689660,_h689662,_h689664,_h689666,FWContext)).
:-(FLORA_THIS_WORKSPACE(copy_into_minus)(_h690423,_h690425,_h690427,_h690429,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(copy_into_minus))(_h690423,_h690425,_h690427,_h690429,FWContext)).
:-(FLORA_THIS_WORKSPACE(delete_all_pairs)(_h691122,_h691124,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(delete_all_pairs))(_h691122,_h691124,FWContext)).
:-(FLORA_THIS_WORKSPACE(delete_facts)(_h691829,_h691831,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(delete_facts))(_h691829,_h691831,FWContext)).
:-(FLORA_THIS_WORKSPACE(delete_from)(_h692472,_h692474,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(delete_from))(_h692472,_h692474,FWContext)).
:-(FLORA_THIS_WORKSPACE(genericdelete)(_h693099,_h693101,_h693103,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(genericdelete))(_h693099,_h693101,_h693103,FWContext)).
:-(FLORA_THIS_WORKSPACE(genericinsert)(_h693762,_h693764,_h693766,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(genericinsert))(_h693762,_h693764,_h693766,FWContext)).
:-(FLORA_THIS_WORKSPACE(genericintersect)(_h694425,_h694427,_h694429,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(genericintersect))(_h694425,_h694427,_h694429,FWContext)).
:-(FLORA_THIS_WORKSPACE(genericmember)(_h695136,_h695138,_h695140,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(genericmember))(_h695136,_h695138,_h695140,FWContext)).
:-(FLORA_THIS_WORKSPACE(genericminus)(_h695799,_h695801,_h695803,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(genericminus))(_h695799,_h695801,_h695803,FWContext)).
:-(FLORA_THIS_WORKSPACE(genericsubset)(_h696446,_h696448,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(genericsubset))(_h696446,_h696448,FWContext)).
:-(FLORA_THIS_WORKSPACE(genericunion)(_h697105,_h697107,_h697109,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(genericunion))(_h697105,_h697107,_h697109,FWContext)).
:-(FLORA_THIS_WORKSPACE(get_storage_name)(_h697752,_h697754,_h697756,_h697758,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(get_storage_name))(_h697752,_h697754,_h697756,_h697758,FWContext)).
:-(FLORA_THIS_WORKSPACE(insert_facts)(_h698467,_h698469,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(insert_facts))(_h698467,_h698469,FWContext)).
:-(FLORA_THIS_WORKSPACE(registry_of_sets)(_h699110,_h699112,_h699114,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(registry_of_sets))(_h699110,_h699112,_h699114,FWContext)).
:-(FLORA_THIS_WORKSPACE(struct_printable_type)(_h699821,_h699823,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(struct_printable_type))(_h699821,_h699823,FWContext)).
