...
:-(FLORA_THIS_WORKSPACE(boundViolated)(_h650755,_h650757,_h650759,_h650761,_h650763,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(boundViolated))(_h650755,_h650757,_h650759,_h650761,_h650763,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(checkBounds)(_h651431,_h651433,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(checkBounds))(_h651431,_h651433,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(is_native)),2),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(is_native)),2)),opaque))).
:-(FLORA_THIS_WORKSPACE(is_native)(_h652063,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(is_native))(_h652063,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(not_complies_with_type_list)(_h652659,_h652661,_h652663,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(not_complies_with_type_list))(_h652659,_h652661,_h652663,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(typeCheckBoolInternal)(_h653551,_h653553,_h653555,_h653557,_h653559,_h653561,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(typeCheckBoolInternal))(_h653551,_h653553,_h653555,_h653557,_h653559,_h653561,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(typeCheckInternal)(_h654359,_h654361,_h654363,_h654365,_h654367,_h654369,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(typeCheckInternal))(_h654359,_h654361,_h654363,_h654365,_h654367,_h654369,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(boundViolated)(_h679285,_h679287,_h679289,_h679291,_h679293,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(boundViolated))(_h679285,_h679287,_h679289,_h679291,_h679293,FWContext)).
:-(FLORA_THIS_WORKSPACE(checkBounds)(_h679956,_h679958,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(checkBounds))(_h679956,_h679958,FWContext)).
:-(FLORA_THIS_WORKSPACE(is_native)(_h680583,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(is_native))(_h680583,FWContext)).
:-(FLORA_THIS_WORKSPACE(not_complies_with_type_list)(_h681174,_h681176,_h681178,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(not_complies_with_type_list))(_h681174,_h681176,_h681178,FWContext)).
:-(FLORA_THIS_WORKSPACE(typeCheckBoolInternal)(_h682061,_h682063,_h682065,_h682067,_h682069,_h682071,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(typeCheckBoolInternal))(_h682061,_h682063,_h682065,_h682067,_h682069,_h682071,FWContext)).
:-(FLORA_THIS_WORKSPACE(typeCheckInternal)(_h682864,_h682866,_h682868,_h682870,_h682872,_h682874,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(typeCheckInternal))(_h682864,_h682866,_h682868,_h682870,_h682872,_h682874,FWContext)).
