...
:-(FLORA_THIS_WORKSPACE(immediate_isa_plg)(_h138128,_h138130,_h138132,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(immediate_isa_plg))(_h138128,_h138130,_h138132,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(immediate_sub_plg)(_h138860,_h138862,_h138864,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(immediate_sub_plg))(_h138860,_h138862,_h138864,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(intermediate_isa_plg)(_h139592,_h139594,_h139596,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(intermediate_isa_plg))(_h139592,_h139594,_h139596,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(intermediate_sub_plg)(_h140372,_h140374,_h140376,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(intermediate_sub_plg))(_h140372,_h140374,_h140376,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(isa_plg)),4),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(isa_plg)),4)),opaque))).
:-(FLORA_THIS_WORKSPACE(isa_plg)(_h141152,_h141154,_h141156,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(isa_plg))(_h141152,_h141154,_h141156,FWContext)).
:-(dynamic(as(','(/(FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(sub_plg)),4),/(FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(sub_plg)),4)),opaque))).
:-(FLORA_THIS_WORKSPACE(sub_plg)(_h141724,_h141726,_h141728,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(sub_plg))(_h141724,_h141726,_h141728,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(immediate_isa_plg)(_h160933,_h160935,_h160937,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(immediate_isa_plg))(_h160933,_h160935,_h160937,FWContext)).
:-(FLORA_THIS_WORKSPACE(immediate_sub_plg)(_h161660,_h161662,_h161664,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(immediate_sub_plg))(_h161660,_h161662,_h161664,FWContext)).
:-(FLORA_THIS_WORKSPACE(intermediate_isa_plg)(_h162387,_h162389,_h162391,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(intermediate_isa_plg))(_h162387,_h162389,_h162391,FWContext)).
:-(FLORA_THIS_WORKSPACE(intermediate_sub_plg)(_h163162,_h163164,_h163166,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(intermediate_sub_plg))(_h163162,_h163164,_h163166,FWContext)).
:-(FLORA_THIS_WORKSPACE(isa_plg)(_h163937,_h163939,_h163941,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(isa_plg))(_h163937,_h163939,_h163941,FWContext)).
:-(FLORA_THIS_WORKSPACE(sub_plg)(_h164504,_h164506,_h164508,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(sub_plg))(_h164504,_h164506,_h164508,FWContext)).
