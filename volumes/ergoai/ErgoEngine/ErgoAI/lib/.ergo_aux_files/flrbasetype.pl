...
:-(FLORA_THIS_WORKSPACE(class_type_error)(_h2259540,_h2259542,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(class_type_error))(_h2259540,_h2259542,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(static^meth)(__X,flapply(startsWith,__Y),'_$ctxt'(_CallerModuleVar,__newcontextvar1,__newcontextvar2)),','('_$_$_ergo''rule_enabled'(308,'flrbasetype_list.flh',FLORA_THIS_MODULE_NAME),','(:(usermod,is_list(__X)),','(';'(:(usermod,is_list(__Y)),:(flrdatatype,flora_is_var_prim(__Y))),','(!,:(flrdatatype_utils,flora_startsWith_list(__X,__Y))))))).
...
:-(FLORA_THIS_WORKSPACE(class_type_error)(_h2313135,_h2313137,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(class_type_error))(_h2313135,_h2313137,FWContext)).
