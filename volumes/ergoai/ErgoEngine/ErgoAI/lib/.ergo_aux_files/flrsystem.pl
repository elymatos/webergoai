...
:-(FLORA_THIS_WORKSPACE(system_ignore_undefined_errors)(_h1739214,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(system_ignore_undefined_errors))(_h1739214,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(system_turn_off_debug)(_h1740146,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(system_turn_off_debug))(_h1740146,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(system_turn_on_debug)(_h1741782,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(system_turn_on_debug))(_h1741782,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(turn_debug_off_for_call)(_h1743386,_h1743388,_h1743390,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(turn_debug_off_for_call))(_h1743386,_h1743388,_h1743390,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(turn_off_debug_list)(_h1744214,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(turn_off_debug_list))(_h1744214,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(turn_on_debug_list)(_h1744970,FWContext),FLORA_THIS_WORKSPACE(FLDYNAPREFIX_UNQ(turn_on_debug_list))(_h1744970,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(system_ignore_undefined_errors)(_h1765426,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(system_ignore_undefined_errors))(_h1765426,FWContext)).
:-(FLORA_THIS_WORKSPACE(system_turn_off_debug)(_h1766353,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(system_turn_off_debug))(_h1766353,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(system_turn_on_debug)(_h1767979,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(system_turn_on_debug))(_h1767979,FWContext)).
...
:-(FLORA_THIS_WORKSPACE(turn_debug_off_for_call)(_h1769573,_h1769575,_h1769577,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(turn_debug_off_for_call))(_h1769573,_h1769575,_h1769577,FWContext)).
:-(FLORA_THIS_WORKSPACE(turn_off_debug_list)(_h1770396,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(turn_off_debug_list))(_h1770396,FWContext)).
:-(FLORA_THIS_WORKSPACE(turn_on_debug_list)(_h1771147,FWContext),FLORA_THIS_WORKSPACE(FLDYNZPREFIX_UNQ(turn_on_debug_list))(_h1771147,FWContext)).
