<div
    class="h-full formAnnotationSet asAnnotationSet"
    hx-trigger="reload-annotationSet from:body"
    hx-target="#workArea"
    hx-swap="innerHTML"
    hx-get="/annotation/as/as/{{$idAnnotationSet}}"
>
...
{{--                </div>--}}
                ...
                <div class="rowDanger flex">
                    ...
                    >
                        <a href="/annotation/fe/sentence/{{$idDocumentSentence}}/{{$idAnnotationSet}}" target="_blank">Edit this AnnotationSet</a>
                    </button>
                    <button
