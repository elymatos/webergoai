...
#   windows64arm/MSVC_mkfile.mak.  Generated from MSVC_mkfile.in by configure.
#
# Usage:
...
!IF EXIST("..\build\windows64arm\custom_settings.mak")
!INCLUDE "..\build\windows64arm\custom_settings.mak"
!ENDIF

CONFIGDIR=..\config\arm64-pc-windows
...
CPP_PROJ=\
	/nologo /W3 /EHsc /D "ARM64" /D "WIN64" /D "_CONSOLE" /c /Fp"$(OBJDIR)/xsb.pch" \
