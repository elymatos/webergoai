...
//    public static function first($conditions, string $select = '*'): object|null
//    {
...
//    public static function getCriteria(?string $tableName = null): Builder
//    {
//        return DBO::table($tableName ?? static::$tableName);
//    }

//    public static function filter(array $filters, Builder $criteria): Builder
//    {
//        if (!empty($filters)) {
